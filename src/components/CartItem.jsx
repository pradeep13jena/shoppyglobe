    ...
    <div className="cart_Item_section">
      <div className='cart_item_info'>
        ...
        <div className="cart_Item_writtenDetails">
          <div>
          <Link to={`/products/${Props.id}`} className='cartItem-title'>{Props.title}</Link>
          ...
          <div className="cartItem_showPrice">
            ...
            <p className='cartItem_OGPrice'>${calculateOriginalPrice(Props.price, Props.discountPercentage).toFixed(1)}</p>
      ...
      <div className='cart_item_button'>
        <div className="cartItem_buttonSection">
          <p onClick={ () => handleIncrement() }><i className="fa-solid fa-plus"></i></p>
          <p>{Props.quantity}</p>
          <p onClick={ () => handleDecrement() }>{Props.quantity < 2 ? <i className="fa-solid fa-trash"></i> : <i className="fa-solid fa-minus"></i>}</p>
        </div>
      </div>
    </div>
  )
