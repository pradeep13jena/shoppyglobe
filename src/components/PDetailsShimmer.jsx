      ...
      <>
        ...
        <div className="bdetails_info">
          <div className="bdetails_img">
            <img
              src="https://dummyimage.com/500x500/EBEBEB/EBEBEB"
              alt="{obj.title + 'images'}"
            />
            <div className="bdetails_buttons"></div>
          </div>
          <div className="bdetails_written">
            <div className="bdetails_impo">
              <h1
                style={{ backgroundColor: "#EBEBEB", color: "#EBEBEB" }}
                className="bdetails_title"
              >
                Red Nail Polish
              </h1>
              <h3
                style={{ backgroundColor: "#EBEBEB", color: "#EBEBEB" }}
                className="bdetails_author"
              >
                Nail Couture
              </h3>
            ...
            <p
              style={{ backgroundColor: "#EBEBEB", color: "#EBEBEB" }}
              className="bdetails_rating"
            >
              <b>Rating:&nbsp;&nbsp;&nbsp;</b> 3.91<span></span>
            </p>
            <p
              style={{ backgroundColor: "#EBEBEB", color: "#EBEBEB" }}
              className="bdetails_rating"
            ...
            <p
              style={{ backgroundColor: "#EBEBEB", color: "#EBEBEB" }}
              className="bdetails_format"
            >
              <b>Dimension:&nbsp;&nbsp;&nbsp;</b>29.06m x 10.89m x 8.11m
            </p>
            <p
              style={{ backgroundColor: "#EBEBEB", color: "#EBEBEB" }}
              className="bdetails_summary"
            >
              <b>Summary:&nbsp;&nbsp;&nbsp;</b>The Red Nail Polish offers a rich
              and glossy red hue for vibrant and polished nails. With a
              quick-drying formula, it provides a salon-quality finish at home.
            </p>
          </div>
        </div>
        <div className="extra_Info">
          <div className="delivery_container">
            ...
            <p
              style={{ backgroundColor: "#EBEBEB", color: "#EBEBEB" }}
              className="bdetails_Language"
            >
              <b>Minimum order:&nbsp;&nbsp;&nbsp;</b>46 Quantity
            </p>
            <p
              style={{ backgroundColor: "#EBEBEB", color: "#EBEBEB" }}
              className="bdetails_summary"
            >
              <b>Return:&nbsp;&nbsp;&nbsp;</b>No return policy
            </p>
            <p
              style={{ backgroundColor: "#EBEBEB", color: "#EBEBEB" }}
              className="bdetails_summary"
            >
              <b>Shipping:&nbsp;&nbsp;&nbsp;</b>Ships in 1 week
            </p>
          </div>
